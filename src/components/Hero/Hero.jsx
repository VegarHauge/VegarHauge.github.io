    ...
    <section id="hero" className={styles.hero}>
      ...
      <div className={`container ${styles.inner}`}>
        <div className={styles.imageWrapper}>
          <img
            src="https://avatars.githubusercontent.com/u/9919?s=400"
            alt="Vegar Hauge"
        ...
        <div className={styles.content}>
          ...
          <h1 className={styles.name}>
            Vegar<br />
            <span className={styles.nameAccent}>Hauge</span>
          </h1>
          <p className={styles.title}>
            Full-Stack Developer &amp; Creative Technologist
          </p>
          <p className={styles.tagline}>
            I craft modern, performant web experiences — from elegant UIs
            to robust back-end systems. Passionate about clean code and
          ...
          <div className={styles.socials}>
            <a href={SITE.github} target="_blank" rel="noreferrer" aria-label="GitHub" className={styles.socialLink}>
            ...
            <a href={SITE.linkedin} target="_blank" rel="noreferrer" aria-label="LinkedIn" className={styles.socialLink}>
